...
This is a template for building a reward function that works with Augento.

Use this as a starting point for your own custom validation logic.

Your code goes in the `main.py` file in the grading function:
...
We fully typed the `Completion` type so you can take advantage of autocompletion or vibe-coding :rocket:

## Deployment

We recommend deploying this code as a Docker container. You can do this yourself, however we recommend using [Fly.io :balloon:](https://fly.io).

We have included a `fly.toml` configuration for your conveniance. You just need to change the name, login with the fly cli and then run `fly launch`.

## Fly installation instructions

<details>
<summary><svg fill="currentColor" class="relative top-[-2px] mr-3" width="24" height="24" viewBox="0 0 24 24">
...
<details>
<summary><svg fill="currentColor" class="relative top-[-2px] mr-3" width="20" height="20" viewBox="0 0 24 24">
    <path d="M0 12v-8.646l10-1.355v10.001h-10zm11 0h13v-12l-13 1.807v10.193zm-1 1h-10v7.646l10 1.355v-9.001zm1 0v9.194l13 1.806v-11h-13z"></path>
  </svg> Windows</summary>
